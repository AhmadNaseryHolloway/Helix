...
urlpatterns = [
    ...
    path('project/dashboard/project_task/update/project_task/<slug:project_num>/<str:id>/', views.project_tasks_update_view, name="project_task_update"),
    path('project/dashboard/project_task/delete/project_task/<slug:project_num>/<str:id>/', views.project_tasks_delete_view, name="project_task_delete"),
